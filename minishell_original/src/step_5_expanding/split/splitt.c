...
#include "ft_std.h"
 ...
 /**
  * * @brief Vérifie si le caractère à la position 'pos' dans 'str' est un
  *		délimiteur non échappé. Il faut compter le nombre de barres obliques
  *		inversées avant le caractère pour déterminer s'il est échappé ou non.
  * @param str La chaîne de caractères à analyser.
  * @param pos La position du caractère à vérifier.
  * @param delims La chaîne de délimiteurs à vérifier.
  * @return 1 si le caractère est un délimiteur non échappé, 0 sinon.
  */
