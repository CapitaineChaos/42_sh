...
/**
 * @brief  Lit le corps d'un heredoc jusqu'à la ligne de fin.
 * @param  prompt  Le prompt à afficher.
 * @param  delim   La chaîne de délimitation.
 * @param  body    Le corps de l'heredoc (sstr).
 * @param  lc      Le numéro de ligne actuel.
 * @note : content n'a pas besoin d'être free, il est géré par sstr.
 * @return true si la lecture s'est bien passée, false si USER CANCEL.
 */
