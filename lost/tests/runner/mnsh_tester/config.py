...
HERE = Path(__file__).resolve().parent.parent   # tests/runner
PROJECT = HERE.parent.parent
MINISHELL_SRC = PROJECT / "minishell_test"      # build DLVL=0
MINISHELL = HERE / "minishell"                  # copie locale
FIXTURES = HERE / "fixtures"
CASES = HERE / "cases"
FAILURES_FILE = HERE / "failures.log"

TEST_MAKE_ARGS = ["NAME=minishell_test", "OBJ_DIR=obj_test", "CFLAGS=-Wall -Wextra -Werror -MMD -MP -DDLVL=0"]
