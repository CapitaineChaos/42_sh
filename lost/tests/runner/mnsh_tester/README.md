...
Testeur différentiel : compare le comportement de `minishell` à celui de
...
permet de comparer minishell et bash quelle que soit leur façon de terminer.
...
constaté est un vrai écart de conformité de minishell, pas du bruit de timing.
...
2. Un préflight vérifie que minishell fonctionne en mode non-interactif.
